angular.module("app").run(['$templateCache', function(a) { a.put('views/project/inputs/right.html', '<div class="form-group has-feedback" show-errors>\n' +
    ...
    '                    <button type="button" class="btn btn-cta-secondary" ng-click="$cancel()" id="fileUpdateCancel">\n' +
    '                        <i class="fa fa-undo"></i> {{cancelText}}\n' +
    '                    </button>\n' +
    '                    <button type="button" class="btn btn-cta-primary" ng-click="$confirm()"\n' +
    ...
    '            </div>\n' +
    '            <div class="modal-footer">\n' +
    '                <button type="button" class="btn btn-cta-secondary" ng-click="$cancel()" id="fileListCancel"><i\n' +
    '                        class="fa fa-undo"></i> {{cancelText}}\n' +
    '                </button>\n' +
    '                <button type="button" class="btn btn-cta-primary" ng-click="$confirm()" id="fileListConfirm"><i\n' +
    ...
    '    <div class="col-md-3">\n' +
    '        <button ng-click="FileSvc.showCreate()" class="btn btn-default" type="button" id="fileCreate">\n' +
    ...
    '        <td class="text-right">\n' +
    '            <button ng-click="FileSvc.showUpdate(item)" class="btn btn-default" type="button"\n' +
    '                    id="{{\'file\'+item.id+\'Update\'}}"><i class="fa fa-pencil-square-o"></i> Edit\n' +
    '            </button>\n' +
    '            <button ng-click="FileSvc.doDelete(item)" class="btn btn-cta-red" type="button"\n' +
    ...
    '                </div>\n' +
    '                <div class="modal-footer">\n' +
    '                    <button type="button" class="btn btn-cta-secondary" ng-click="$cancel()" id="fileCreateCancel">\n' +
    '                        <i class="fa fa-undo"></i> {{cancelText}}\n' +
    '                    </button>\n' +
    '                    <button type="button" class="btn btn-cta-primary" ng-click="$confirm()"\n' +
    ...
    '       class="btn btn-cta-default btn-xs pull-right" ng-if="AccountSvc.isAdmin()"\n' +
    ...
    '                <div ng-include="\'views/project/inputs/central.html\'"></div>\n' +
    '                <div>\n' +
    '                    <button ng-click="ProjectSvc.doCreate(ProjectSvc.item)" class="btn btn-cta-primary"\n' +
    '                            ng-disabled="!projectForm.$valid" id="projectCreate">\n' +
    '                        <i class="fa fa-check"></i> Create\n' +
    '                    </button>\n' +
    '                    <button ng-click="ProjectSvc.doAddImage()" class="btn btn-cta-secondary pull-right"\n' +
    '                            id="projectAddImage">\n' +
    '                        <i class="fa fa-plus"></i>Add image\n' +
    '                    </button>\n' +
    '                </div>\n' +
