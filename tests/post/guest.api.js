    ...
    describe('Get posts list', function() {
        ...
        describe('Get first post', function() {
            ...
            beforeEach(function(done){
                ...
                //api.debug=true;
                api.getJson('/api/v1/post/'+listResponse.data[0].name, function(response){
            ...
            describe('Get posts list by tag', function() {
                ...
                beforeEach(function(done){
                    ...
                    //api.debug=true;
                    api.getJson('/api/v1/post/list_by_tag/'+listResponse.data[0].tags[0].text, function(response){
